...
export const Points = observer(() => {
    ...
    return (
        <div className="rounded-[20px] shadow-[0px_3px_4px_0px_#0000000A] max-w-[600px] min-w-[500px]">
            <div className="p-6 bg-[#fefefe] shadow-[0px_12px_23px_0px_#3E49540A] mb-7 flex fledx-row w-full justify-between">
                ...
                <Button onClick={() => navigate('/pickup/create')} children="+ Добавить" class="bg-[#2953E8] rounded-[18px] !py-1.5 !px-5 shadow-[0px_4px_4px_0px_#00000040]"/>
            </div>
