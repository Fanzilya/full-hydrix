...
export const RequestRegistry = () => {
    ...
    return (
        <>
            <div className="informations-dispatch__requestregistry requestregistry-dispatch dispatch-background relative mt-10">
                <div className="absolute  top-[-38px] left-[30px] flex gap-3">
                    ...
                    <Link to="/dispatcher/orders/create" className={`hover:bg-[var(--clr-accent)] hover:text-white duration-300 cursor-pointer px-[15px] pt-[7px] pb-[6px] rounded-tl-lg rounded-tr-lg font-semibold  ${location.pathname == "/dispatcher/orders/create" ? "bg-[var(--clr-accent)] text-white" : "bg-[#E6E9EF] text-[#757575]"}`}>
                        Создание заявки
                    </Link>
                </div>
